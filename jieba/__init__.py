...
def initialize(*args):
    ...
    with DICT_LOCK:
        ...
        #print >> sys.stderr, "loading model from cache " + str(cache_file)
        #try:
        ...
        min_freq = min(FREQ.itervalues())
            #print >> sys.stderr, "dumping model to file cache " + str(cache_file)
            #tmp_suffix = "."+str(random.random())
            #tmp_cache = tempfile.TemporaryFile( mode='w+b', suffix=tmp_suffix )
            #with open(tmp_cache,'wb') as temp_cache_file:
            ...
            #replace_file(tmp_cache ,cache_file)
